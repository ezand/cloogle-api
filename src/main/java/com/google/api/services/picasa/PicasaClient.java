...
import com.google.api.services.picasa.model.*;
import com.google.api.services.shared.gdata.xml.GDataXmlClient;
...
public final class PicasaClient extends GDataXmlClient {
    ...
    public PhotoDetailsFeed executeGetPhotoDetailsFeed(PicasaUrl url) throws IOException {
        url.kinds = "photo";
        return executeGet(url, PhotoDetailsFeed.class);
    }
